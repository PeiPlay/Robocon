/*!
 * @file ICM42688.h
 * @brief Define the basic structure of ICM42688 class
...
#define ICM42688_I2C_L_ADDR 0x68 
#define ICM42688_I2C_H_ADDR 0x69
...
#define SPI2_CS_H  LL_GPIO_SetOutputPin(SPI2_CS_GPIO_Port,SPI2_CS_Pin);
#define SPI2_CS_L  LL_GPIO_ResetOutputPin(SPI2_CS_GPIO_Port,SPI2_CS_Pin);
   ...
   * @n                   Gyroscope needs to be kept ON for a minimum of 45ms. When transitioning from OFF to any of the other modes, do not issue any register writes for 200¦Ìs
   ...
   * @n                    When transitioning from OFF to any of the other modes, do not issue any register writes for 200¦Ìs
   */
  typedef struct {
    uint8_t   accelMode: 2; 
    uint8_t   gyroMode: 2; 
  ...
  */
   ...
   * @n        FIFO_WM_GT_TH Trigger FIFO watermark interrupt on every ODR (DMA write) if FIFO_COUNT ¡Ý FIFO_WM_TH
   ...
   * @n        TMST_RES : Time Stamp resolution: When set to 0 (default), time stamp resolution is 1 ¦Ìs. When set to 1, resolution is 16¦Ìs
   ...
   * @return Temperature value, unit: ¡æ
   */
   ...
   * @n       FSR_0      Gyro:¡À2000dps   /   Accel: ¡À16g
   * @n       FSR_1      Gyro:¡À1000dps   /   Accel: ¡À8g
   * @n       FSR_2      Gyro:¡À500dps    /   Accel: ¡À4g
   * @n       FSR_3      Gyro:¡À250dps    /   Accel: ¡À2g
   * @n       FSR_4      Gyro:¡À125dps    /   Accel: not optional
   * @n       FSR_5      Gyro:¡À62.5dps   /   Accel: not optional
   * @n       FSR_6      Gyro:¡À31.25dps  /   Accel: not optional
   * @n       FSR_7      Gyro:¡À15.625dps /   Accel: not optional
   * @return Set result
...
extern uint8_t _r, _g, _b;
extern uint8_t _mode;
extern uint8_t _tapNum ;
extern uint8_t _tapAxis;
extern uint8_t _tapDir ;
extern float _gyroRange;
extern float _accelRange;
extern bool FIFOMode;
extern int16_t _accelX;
extern int16_t _accelY;
extern int16_t _accelZ;
extern int16_t _gyroX;
extern int16_t _gyroZ;
extern int16_t _gyroY;
extern int8_t _temp;
extern int8_t _INTPin;
extern uint8_t id;

extern sAccelConfig0_t accelConfig0;
extern sPWRMgmt0_t PWRMgmt0;
extern sINTFConfig1_t INTFConfig1;
extern sAccelConfig1_t accelConfig1;
extern sGyroAccelConfig0_t gyroAccelConfig0;
extern sAPEXConfig7_t APEXConfig7;
extern sAPEXConfig8_t APEXConfig8;
extern sSMDConfig_t SMDConfig;
extern sGyroConfig1_t  gyroConfig1;
extern sFIFOConfig1_t FIFOConfig1;
extern sINTConfig_t INTConfig;
extern sGyroConfig0_t gyroConfig0;
extern sAPEXConfig0_t APEXConfig0;
extern sGyroConfigStatic9_t gyroConfigStatic9;
extern sGyroConfigStatic2_t gyroConfigStatic2;
extern sGyroConfigStatic5_t gyroConfigStatic5;
extern sAccelConfigStatic2_t accelConfigStatic2;
extern sAccelConfigStatic4_t accelConfigStatic4;
extern sINTSource_t  INTSource;
